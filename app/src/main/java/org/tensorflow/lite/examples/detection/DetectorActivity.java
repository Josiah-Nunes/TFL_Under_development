              ...
              public void run() {
                ...
                for (final Detector.Recognition result : results) {
                  ...
                  if (location != null && result.getConfidence() >= minimumConfidence) {
                      ...
                      Detector.Recognition rloc = results.get(0);
                      RectF oneloc = rloc.getLocation();
                      ...
                      else if (oneloc.top>=150f)
                      {
                          ...
                          {
                              System.out.println("MMOOOOOOOVVVVEEEE   RRRIIGGGGHHHTTTTT");
                              textToSpeech.speak("Move right",TextToSpeech.QUEUE_FLUSH, null, null);
                              try {
                                  Thread.sleep(700);
                              } catch (InterruptedException e) {
                                  e.printStackTrace();
                          ...
                          {
                              System.out.println("MMOOOOOOOVVVVEEEE   LLLLLEEEEFFFFFTTTT");
                              textToSpeech.speak("Move Left", TextToSpeech.QUEUE_FLUSH, null, null);
                              try {
                                  Thread.sleep(700);
                              } catch (InterruptedException e) {
                                  e.printStackTrace();
