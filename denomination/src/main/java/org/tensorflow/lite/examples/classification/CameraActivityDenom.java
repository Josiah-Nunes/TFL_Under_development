...
public class CameraActivityDenom extends AppCompatActivity implements OnImageAvailableListener, Camera.PreviewCallback, View.OnClickListener, AdapterView.OnItemSelectedListener {
  ...
  protected void setFragment() {
    ...
    Fragment fragment;
    if (useCamera2API) {
      CameraConnectionFragmentDenom camera2Fragment =
              CameraConnectionFragmentDenom.newInstance(
                      new CameraConnectionFragmentDenom.ConnectionCallback() {
                        @Override
                        public void onPreviewSizeChosen(final Size size, final int rotation) {
                          previewHeight = size.getHeight();
                          previewWidth = size.getWidth();
                          CameraActivityDenom.this.onPreviewSizeChosen(size, rotation);
                        }
                      },
                      this,
                      getLayoutId(),
      ...
      fragment =
              new LegacyCameraConnectionFragmentDenom(this, getLayoutId(), getDesiredPreviewFrameSize());
    }
